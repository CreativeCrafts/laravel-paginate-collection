...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-paginate-collection.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-paginate-collection)
...
```bash
php artisan vendor:publish --tag="laravel-paginate-collection-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-paginate-collection-views"
```

## Usage

```php
$paginate = new CreativeCrafts\Paginate();
echo $paginate->echoPhrase('Hello, CreativeCrafts!');
```
